...
const questions = [
    { note: 'Sol2', positionY: 110, correctAnswer: 'Sol' }, { note: 'Lá2', positionY: 102.5, correctAnswer: 'Lá' },
    { note: 'Si2', positionY: 95, correctAnswer: 'Si' }, { note: 'Dó3', positionY: 87.5, correctAnswer: 'Dó' },
    { note: 'Ré3', positionY: 80, correctAnswer: 'Ré' }, { note: 'Mi3', positionY: 72.5, correctAnswer: 'Mi' },
    { note: 'Fá3', positionY: 65, correctAnswer: 'Fá' }, { note: 'Sol3', positionY: 57.5, correctAnswer: 'Sol' },
    { note: 'Lá3', positionY: 50, correctAnswer: 'Lá' }, { note: 'Si3', positionY: 42.5, correctAnswer: 'Si' },
    { note: 'Dó4', positionY: 35, correctAnswer: 'Dó', ledgerLines: [35] }, { note: 'Mi2', positionY: 125, correctAnswer: 'Mi', ledgerLines: [125] }
];

// --- CONFIGURAÇÃO DOS NÍVEIS ---
const levels = { 1: { time: 10, questions: 10 }, 2: { time: 7, questions: 10 }, 3: { time: 5, questions: 10 }, 4: { time: 3.5, questions: 10 }};
