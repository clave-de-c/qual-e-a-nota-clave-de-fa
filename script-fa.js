...
// --- DADOS DAS PERGUNTAS (CLAVE DE FÁ) ---
const questions = [
    { note: 'Sol2', positionY: 110, correctAnswer: 'Sol' },
    { note: 'Lá2', positionY: 102.5, correctAnswer: 'Lá' },
    { note: 'Si2', positionY: 95, correctAnswer: 'Si' },
    { note: 'Dó3', positionY: 87.5, correctAnswer: 'Dó' },
    { note: 'Ré3', positionY: 80, correctAnswer: 'Ré' },
    { note: 'Mi3', positionY: 72.5, correctAnswer: 'Mi' },
    { note: 'Fá3', positionY: 65, correctAnswer: 'Fá' },
    { note: 'Sol3', positionY: 57.5, correctAnswer: 'Sol' },
    { note: 'Lá3', positionY: 50, correctAnswer: 'Lá' },
    { note: 'Si3', positionY: 42.5, correctAnswer: 'Si' },
    { note: 'Dó4', positionY: 35, correctAnswer: 'Dó', ledgerLines: [35] }, // Nota com linha suplementar
    { note: 'Mi2', positionY: 125, correctAnswer: 'Mi', ledgerLines: [125] } // Nota com linha suplementar
];
